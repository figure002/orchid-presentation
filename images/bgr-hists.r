...
pdf('bgr-hist-hor.pdf')
matplot(hor, type = c("b"), pch=1, col = c("blue","red","dark green"), xlab="Bin", ylab="Mean Color Frequency", ylim=c(0,255), main = "BGR Color Frequencies for Horizontal Bins")
dev.off()
pdf('bgr-hist-ver.pdf')
matplot(ver, type = c("b"), pch=1, col = c("blue","red","dark green"), xlab="Bin", ylab="Mean Color Frequency", ylim=c(0,255), main = "BGR Color Frequencies for Vertical Bins")
dev.off()
