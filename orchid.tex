...
\section{Introduction}
    ...
    \note{Explain what landmarks are (from the previous slide).}
    \note{Photo from Van der Niet et al. Three-dimensional geometric morphometrics for studying floral shape variation. Trends Plant Sci. 15, 423–6 (2010).}
